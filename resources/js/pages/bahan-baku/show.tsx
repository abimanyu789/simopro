            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{item.nama_bahan}</p>
                        </div>
                    </div>
                ...
                <div className="mx-auto w-full max-w-3xl space-y-6">
                    ...
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border">
                        <h2 className="mb-4 text-lg font-semibold">Informasi Bahan Baku</h2>
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                <p className="text-sm font-medium text-muted-foreground">
                                    Kode Bahan
                                </p>
                                <p className="mt-1 font-mono text-sm">{item.kode_bahan}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-muted-foreground">
                                    Nama Bahan
                    ...
                    {/* Stock Info */}
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border">
                        <h2 className="mb-4 text-lg font-semibold">Informasi Stok</h2>
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                <p className="text-sm font-medium text-muted-foreground">
                                    Stok Saat Ini
                    ...
                    {/* History Info */}
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border">
                        <h2 className="mb-4 text-lg font-semibold">Riwayat Stok</h2>
                        <div className="flex h-32 items-center justify-center rounded-lg border-2 border-dashed border-muted">
                            <p className="text-sm text-muted-foreground">
                                Riwayat perubahan stok akan tersedia setelah Modul 9 (Stok Bahan
                                Baku) selesai
                            </p>
                        </div>
                    </div>
                    ...
                    {/* Metadata */}
                    <div className="rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border">
                        <h2 className="mb-4 text-lg font-semibold">Informasi Sistem</h2>
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                <p className="text-sm font-medium text-muted-foreground">
                                    Dibuat Pada
