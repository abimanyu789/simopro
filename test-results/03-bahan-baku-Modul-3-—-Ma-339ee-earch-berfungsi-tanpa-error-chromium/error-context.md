...
- Name: 03-bahan-baku.spec.ts >> Modul 3 — Master Data Bahan Baku >> 3.2 search berfungsi tanpa error
- Location: tests\e2e\03-bahan-baku.spec.ts:25:5
...
Call log:
  - waiting for locator('input[type="text"], input[placeholder*="Cari"]').first()
