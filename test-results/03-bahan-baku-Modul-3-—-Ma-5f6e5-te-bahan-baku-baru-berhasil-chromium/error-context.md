...
- Name: 03-bahan-baku.spec.ts >> Modul 3 — Master Data Bahan Baku >> 3.4 create bahan baku baru berhasil
- Location: tests\e2e\03-bahan-baku.spec.ts:50:5
...
Call log:
  - waiting for locator('input[id="kode_bahan"]')
